---
name: add-parallel
description: Add Parallel AI MCP integration to NanoClaw for quick search and deep research workflows.
---
...
Replace with:
```typescript
const allowedVars = ['OPENAI_API_KEY', 'CODEX_API_KEY', 'PARALLEL_API_KEY'];
```
