  ...
  if (!fs.existsSync(settingsFile)) {
    fs.writeFileSync(settingsFile, JSON.stringify({
      env: {
        ...
        CODEX_ADDITIONAL_DIRECTORIES_AGENTS_MD: '1',
        // Enable Codex memory feature (persists user preferences between sessions)
...
function readSecrets(): Record<string, string> {
  return readEnvFile(['OPENAI_API_KEY', 'CODEX_API_KEY']);
}
