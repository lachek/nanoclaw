...
I don't need an installation wizard - Codex CLI guides the setup. I don't need a monitoring dashboard - I ask the agent what's happening. I don't need elaborate logging UIs - I ask the agent to read the logs. I don't need debugging tools - I describe the problem and the agent fixes it.
...
- Use existing tools (WhatsApp connector, Codex CLI SDK, MCP servers)
- Minimal glue code
